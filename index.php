...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="search-popup-container">
        <form role="search" method="get" class="search-form" action="shop.php">
        ...
        <ul class="cat-list">
            <li class="cat-list-item"><a href="shop.php?category=Mobile&search=&sort=name_asc" title="Mobile Phones">Mobile Phones</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Smart Watches&search=&sort=name_asc" title="Smart Watches">Smart Watches</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Headphones&search=&sort=name_asc" title="Headphones">Headphones</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Accessories&search=&sort=name_asc" title="Accessories">Accessories</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Monitors&search=&sort=name_asc" title="Monitors">Monitors</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Speakers&search=&sort=name_asc" title="Speakers">Speakers</a></li>
            <li class="cat-list-item"><a href="shop.php?category=Memory Cards&search=&sort=name_asc" title="Memory Cards">Memory Cards</a></li>
        </ul>
    </div>
</div>
